...
*/
            ...
            console.log(raw.slice(0x0c, 0x0e).toString('hex') + '.' + raw.slice(0x0e, 0x10).toString('hex'));
            console.log(latDir);
            /*console.log(raw.slice(0x11, 0x13).toString('hex') + '.' + raw.slice(0x13, 0x15).toString('hex'));
            let long = raw.slice(0x11, 0x13).toString('hex');
            long += raw.slice(0x13, 0x14)[0] >>> 4;
            long += '.';
            let asdf = raw.slice(0x13, 0x14) & 0x0f;
            long += adsf.toString();
            console.log(lastDigitLongitude);
            console.log(lastDigitLongitude.toString());
            console.log(longDir);
            */
            ...
            //longitudeString += lastDigitLongitude.toString();
            //console.log(longitudeString);
