...
*/
            ...
            */
            ...
            // 01525.4367 E
            longitudeString = longitudeString.substring(0,5) + '.' + longitudeString.substring(5,8);
            ...
            result = {
                ...
                geo: {
                    ...
                    longitude: tk102.dmm2ddd(raw.slice(0x11, 0x13).toString('hex') + '.' + raw.slice(0x13, 0x15).toString('hex') + lastDigitLongitude.toString(), longDir)
                },
                valid: validGps
            };
