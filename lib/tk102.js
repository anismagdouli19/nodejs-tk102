...
*/
            ...
            result = {
                ...
                imei: raw.slice(0x01,0x06).toString(),
                datetime : Date.now(),
                geo: {
                    //PAJ Format: 4706.0414 N 01525.4367 E
                    latitude: tk102.dmm2ddd(raw.slice(0x0c, 0x0e).toString() + '.' + raw.slice(0x0e, 0x10).toString(), latDir),
                    longitude: tk102.dmm2ddd(raw.slice(0x11, 0x13).toString() + '.' + raw.slice(0x13, 0x15).toString() + lastDigitLongitude.toString(), longDir)
                },
                valid: validGps
            };
