...
const specsLKGPSbinary = [
    function (data) {
        ...
        let lastDigitLongitude = direction >>> 4;
        console.log(lastDigitLongitude);
        console.log(direction & 0xf0);
        ...
        try {
            ...
            result = {
                ...
                geo: {
                    ...
                    latitude: tk102.dmm2ddd(raw.slice(0x0c, 0x0e).toString() + ',' + raw.slice(0x0e, 0x10).toString(), raw.slice(0x15, 0x16)),
                    longitude: tk102.dmm2ddd(str[7], str [8])
                },
                imei: str [1]
            };
